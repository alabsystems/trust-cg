// trust-cg-verify/peephole_proofs.rs - SMT proofs for peephole optimization rules
//
// Author: Andrew Yates <andrewyates.name@gmail.com>
// Copyright 2026 Andrew Yates | License: Apache-2.0
//
// Proves that each peephole rewrite rule preserves semantics. The rules
// live in trust-cg-opt's declarative rewrite framework
// (crates/trust-cg-opt/src/rewrite/patterns.rs) plus the standalone
// rotate_idiom pass; the hand-written peephole.rs pass they migrated out
// of (#393) has been deleted. Rules include identity copies, arithmetic
// identities, power-of-two shifts, and mask/bitfield rewrites, so we prove the
// common semantic contract:
// forall inputs, LHS_semantics(inputs) == RHS_semantics(inputs).
//
...
//
// Reference: crates/trust-cg-opt/src/rewrite/patterns.rs

//! SMT proofs for AArch64 peephole optimization rules.
//!
//! Each proof corresponds to a rewrite rule in `trust-cg-opt::rewrite`
//! (formerly the hand-written `trust-cg-opt::peephole` pass, deleted
//! under #393 once the declarative framework reached parity):
//!
...
pub fn proof_add_zero_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_add_ri(xn.clone(), 0, width),
...
pub fn proof_sub_zero_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sub_ri(xn.clone(), 0, width),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_mul_one_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_mul_ri(xn.clone(), 1, width),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_lsl_zero_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_lsl_ri(xn.clone(), 0, width),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_lsr_zero_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_lsr_ri(xn.clone(), 0, width),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_asr_zero_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_asr_ri(xn.clone(), 0, width),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_orr_self_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_orr_rr(xn.clone(), xn.clone()),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_and_self_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_and_rr(xn.clone(), xn.clone()),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_eor_zero_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_eor_ri(xn.clone(), 0, width),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_orr_ri_zero_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_orr_ri(xn.clone(), 0, width),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_and_ri_allones_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_and_ri(xn.clone(), u64::MAX, width),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_sub_rr_self_zero() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sub_rr(xn.clone(), xn),
...
pub fn proof_eor_rr_self_zero() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_eor_rr(xn.clone(), xn),
        aarch64_expr: encode_mov_imm(0, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_and_ri_zero() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_and_ri(xn, 0, width),
        aarch64_expr: encode_mov_imm(0, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_orr_ri_allones() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_orr_ri(xn, u64::MAX, width),
...
pub fn proof_add_rr_self_to_lsl() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_add_rr(xn.clone(), xn.clone()),
...
pub fn proof_neg_neg_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_neg(encode_neg(xn.clone())),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_add_neg_to_sub() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_add_rr(xn.clone(), encode_neg(xm.clone())),
...
pub fn proof_sub_neg_to_add() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sub_rr(xn.clone(), encode_neg(xm.clone())),
...
pub fn proof_mul_pow2_k1() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_mul_ri(xn.clone(), 2, width),
        aarch64_expr: encode_lsl_ri(xn, 1, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_mul_pow2_k2() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_mul_ri(xn.clone(), 4, width),
...
pub fn proof_mul_pow2_k3() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_mul_ri(xn.clone(), 8, width),
...
pub fn proof_udiv_pow2_k1() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_udiv_ri(xn.clone(), 2, width),
...
pub fn proof_udiv_pow2_k2() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_udiv_ri(xn.clone(), 4, width),
...
pub fn proof_add_neg_imm_to_sub() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_add_ri(xn.clone(), -5i64 as u64, width),
...
pub fn proof_sub_neg_imm_to_add() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sub_ri(xn.clone(), -7i64 as u64, width),
...
pub fn proof_bic_self_zero() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_bic_rr(xn.clone(), xn, width),
        aarch64_expr: encode_mov_imm(0, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_orn_self_allones() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_orn_rr(xn.clone(), xn, width),
        aarch64_expr: encode_mov_imm(u64::MAX, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_sxtb_idempotent() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sign_extend(encode_sign_extend(xn.clone(), 8, width), 8, width),
...
pub fn proof_lsl_lsr_to_and() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_lsl_ri(encode_lsr_ri(xn.clone(), k, width), k, width),
...
/// Proof: `LSR Xn,#k` then `AND #((1<<w)-1)` is equivalent to `UBFX Xn,#k,#w`
/// (i.e. `UBFM` with `immr = k`, `imms = k + w - 1`).
///
/// Theorem: forall xn : BV64 .
///     (xn >>u k) & ((1 << w) - 1) == zero_extend(extract(xn, k+w-1, k))
///
/// # Why this obligation is OWED
///
/// `Ubfm` is bound to a proof by OPCODE (`function_verifier.rs`:
/// `Ubfm => Some(("ubfm extract w", ...))`), and that proof's SOURCE side is
/// trust_ir `ExtractBits` -- it discharges "lowering ExtractBits to UBFM
/// preserves semantics". A peephole that SYNTHESIZES a `Ubfm` out of
/// `LSR; AND` has a different origin, so crediting it with the ExtractBits
/// proof would claim proven a theorem nobody stated. This obligation states the
/// one the peephole actually needs.
///
/// # Why it is not degenerate
///
/// The machine side is deliberately written with EXTRACT/ZERO-EXTEND algebra
/// rather than as `(x >> k) & mask`. Writing it the second way would make both
/// sides syntactically identical and the "proof" would be a vacuous X == X --
/// exactly the degenerate shape this codebase retracts. The extract form is how
/// UBFM is actually defined (select the bit range, zero the rest), so the
/// solver has to relate two genuinely different formulations.
pub fn proof_lsr_and_to_ubfx() -> ProofObligation {
    let width = 64;
    let xn = SmtExpr::var("xn", width);
    // Representative instance: extract 4 bits starting at bit 8 -- the shape
    // b1_mispredict produces from `((s >> 8) & 15)`.
    let k = 8u32;
    let w = 4u32;
    let mask = (1u64 << w) - 1;
    ...
    ProofObligation {
        machine_side_provenance: crate::lowering_proof::MachineSideProvenance::StaticDb,
        name: "Peephole: AND(LSR(Xn, #8), #0xF) ≡ UBFX Xn, #8, #4".to_string(),
        trust_ir_expr: encode_and_ri(encode_lsr_ri(xn.clone(), k as u64, width), mask, width),
        // UBFM/UBFX semantics, faithfully: take bits [k+w-1 : k] and zero-extend
        // back to the register width.
        aarch64_expr: xn.extract(k + w - 1, k).zero_ext(width - w),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
        category: Some(crate::lowering_proof::TransvalCheckKind::PeepholeOptimization),
...
/// 32-bit sibling of [`proof_lsr_and_to_ubfx`].
pub fn proof_lsr_and_to_ubfx_w32() -> ProofObligation {
    let width = 32;
    let xn = SmtExpr::var("xn", width);
    let k = 4u32;
    let w = 4u32;
    ...
    ProofObligation {
        machine_side_provenance: crate::lowering_proof::MachineSideProvenance::StaticDb,
        name: "Peephole: AND(LSR(Wn, #4), #0xF) ≡ UBFX Wn, #4, #4".to_string(),
        trust_ir_expr: encode_and_ri(encode_lsr_ri(xn.clone(), k as u64, width), mask, width),
        aarch64_expr: xn.extract(k + w - 1, k).zero_ext(width - w),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
...
pub fn proof_neg_sub_swap() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_neg(encode_sub_rr(xn.clone(), xm.clone())),
...
pub fn proof_mul_neg_one_to_neg() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_mul_ri(xn.clone(), u64::MAX, width), // -1 as u64
...
pub fn proof_lsr_lsl_to_and() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_lsr_ri(encode_lsl_ri(xn.clone(), k, width), k, width),
        aarch64_expr: encode_and_ri(xn, mask, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_mul_neg_one_to_neg_i8() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_mul_ri(xn.clone(), 0xFF, width), // -1 as u8
        aarch64_expr: encode_neg(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_add_neg_imm_to_sub_i8() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_add_ri(xn.clone(), (-5i8 as u8) as u64, width),
        aarch64_expr: encode_sub_ri(xn, 5, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_sub_neg_imm_to_add_i8() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sub_ri(xn.clone(), (-7i8 as u8) as u64, width),
        aarch64_expr: encode_add_ri(xn, 7, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_sdiv_one_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sdiv_ri(xn.clone(), 1, width),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_mul_zero_absorb() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_mul_ri(xn, 0, width),
        aarch64_expr: encode_mov_imm(0, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_madd_one_to_add() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_madd(xn.clone(), one, xa.clone()),
...
pub fn proof_madd_zero_to_mov() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_madd(xn, zero, xa.clone()),
...
pub fn proof_msub_one_to_sub() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_msub(xn.clone(), one, xa.clone()),
...
pub fn proof_msub_zero_to_mov() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_msub(xn, zero, xa.clone()),
        aarch64_expr: encode_mov(xa),
        inputs: vec![("xn".to_string(), width), ("xa".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_sxth_sxtb_subsume() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sign_extend(encode_sign_extend(xn.clone(), 8, width), 16, width),
        aarch64_expr: encode_sign_extend(xn, 8, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_sxtw_sxth_subsume() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sign_extend(encode_sign_extend(xn.clone(), 16, width), 32, width),
...
pub fn proof_add_sub_cancel() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_sub_rr(xn.clone(), xm.clone()).bvadd(xm),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width), ("xm".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_sub_add_cancel() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_add_rr(xn.clone(), xm.clone()).bvsub(xm),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width), ("xm".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_csel_same_arms() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_mov(xn.clone()),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_udiv_one_identity() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: xn.clone().bvudiv(SmtExpr::bv_const(1, width)),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_sdiv_neg_one_to_neg() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: xn.clone().bvsdiv(SmtExpr::bv_const(neg_one, width)),
...
pub fn proof_uxtb_idempotent() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_zero_extend(encode_zero_extend(xn.clone(), 8, width), 8, width),
...
pub fn proof_uxth_uxtb_subsume() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_zero_extend(encode_zero_extend(xn.clone(), 8, width), 16, width),
        aarch64_expr: encode_zero_extend(xn, 8, width),
        inputs: vec![("xn".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn proof_uxtw_uxth_subsume() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_zero_extend(encode_zero_extend(xn.clone(), 16, width), 32, width),
...
pub fn proof_add_sub_reverse_cancel() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: xn.clone().bvadd(encode_sub_rr(xm.clone(), xn)),
...
pub fn proof_eor_cancel() -> ProofObligation {
    ...
    ProofObligation {
        ...
        trust_ir_expr: encode_eor_rr(encode_eor_rr(xn.clone(), xm.clone()), xm),
        aarch64_expr: encode_mov(xn),
        inputs: vec![("xn".to_string(), width), ("xm".to_string(), width)],
        preconditions: vec![],
        fp_inputs: vec![],
...
pub fn all_peephole_proofs_all_widths() -> Vec<ProofObligation> {
    ...
    // #62 retraction: "Peephole: CSEL Xd,Xn,Xn,cond ≡ MOV Xd,Xn" was a degenerate
    // X==X self-equality (it only restated Xn==Xn through the select; no
    // independent CSEL encoder), so it proved nothing and is removed.
    proofs.retain(|p| p.name != "Peephole: CSEL Xd, Xn, Xn, cond ≡ MOV Xd, Xn");
    proofs
}
...
mod tests {
    ...
    #[test]
    fn test_proof_lsr_and_to_ubfx() {
        assert_valid(&proof_lsr_and_to_ubfx());
        assert_valid(&proof_lsr_and_to_ubfx_w32());
    }

    /// The obligation must be NON-DEGENERATE: the two sides have to be
    /// syntactically different formulations, or the "proof" is a vacuous X == X
    /// that would discharge no matter what UBFM actually does. Writing the
    /// machine side as `(x >> k) & mask` instead of extract/zero-extend is the
    /// exact way this goes wrong.
    #[test]
    fn ubfx_obligation_is_not_degenerate() {
        for ob in [proof_lsr_and_to_ubfx(), proof_lsr_and_to_ubfx_w32()] {
            assert_ne!(
                format!("{:?}", ob.trust_ir_expr),
                format!("{:?}", ob.aarch64_expr),
                "{}: sides are identical — this proves nothing",
                ob.name
            );
        }
    }

    /// A WRONG bit range must be refuted. If shifting the extract window by one
    /// still "proves", the obligation is not constraining the immediates and
    /// would bless an off-by-one peephole.
    #[test]
    fn ubfx_obligation_refutes_wrong_bit_range() {
        let width = 64;
        let xn = SmtExpr::var("xn", width);
        let (k, w) = (8u32, 4u32);
        let mut bad = proof_lsr_and_to_ubfx();
        // extract one bit too high
        bad.aarch64_expr = xn.extract(k + w, k + 1).zero_ext(width - w);
        assert!(
            !matches!(verify_by_evaluation(&bad), VerificationResult::Valid),
            "a shifted extract window must NOT verify — the obligation would \
             bless an off-by-one peephole"
        );
    }
    ...
    fn test_wrong_add_nonzero_detected() {
        ...
        let obligation = ProofObligation {
            ...
            trust_ir_expr: encode_add_ri(xn.clone(), 1, width),
            aarch64_expr: encode_mov(xn),
            inputs: vec![("xn".to_string(), width)],
            preconditions: vec![],
            fp_inputs: vec![],
    ...
    fn test_wrong_orr_different_regs_detected() {
        ...
        let obligation = ProofObligation {
            ...
            trust_ir_expr: encode_orr_rr(xn.clone(), xm),
            aarch64_expr: encode_mov(xn),
            inputs: vec![("xn".to_string(), width), ("xm".to_string(), width)],
            preconditions: vec![],
            fp_inputs: vec![],
    ...
    fn test_wrong_lsl_nonzero_detected() {
        ...
        let obligation = ProofObligation {
            ...
            trust_ir_expr: encode_lsl_ri(xn.clone(), 1, width),
            aarch64_expr: encode_mov(xn),
            inputs: vec![("xn".to_string(), width)],
            preconditions: vec![],
            fp_inputs: vec![],
    ...
    fn test_wrong_eor_nonzero_detected() {
        ...
        let obligation = ProofObligation {
            ...
            trust_ir_expr: encode_eor_ri(xn.clone(), 0xFF, width),
            aarch64_expr: encode_mov(xn),
            inputs: vec![("xn".to_string(), width)],
            preconditions: vec![],
            fp_inputs: vec![],
