// trust-cg-verify/x86_64_eflags_proofs.rs - x86-64 EFLAGS direct proof obligations
//
// Author: Andrew Yates <andrewyates.name@gmail.com>
// Copyright 2026 Andrew Yates | License: Apache-2.0
//
// Direct ay proof obligations for x86-64 CMP/SUB flag writes (SF/ZF/CF/OF).
//
...
//!
//! Scope: i8 (the ay smoke lane's strict-verification width).
...
//
// The trust_ir side would be `Isub(a, b)` for the numeric result; here we pin
