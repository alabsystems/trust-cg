// trust-cg-llvm-import / lib.rs
//
// Author: Andrew Yates <andrewyates.name@gmail.com>
// Copyright 2026 Andrew Yates | License: Apache-2.0
//
// Minimal LLVM-IR text (.ll) -> trust_ir importer. See crate-level README
...
// and types) and translate directly to `trust_ir::Inst` variants. Every
...
/// text into a `trust_ir::Module`.
pub fn import_path(path: &Path) -> Result<trust_ir::Module> {
    import_module(path)
}
