// trust-cg-lower/va_list.rs - Apple AArch64 va_list intrinsic lowering
//
...
pub fn lower_va_arg(ty: &Type) -> VaArgLowering {
    match ty {
        ...
        // F16/F32 are promoted to an 8-byte slot; F64 occupies 8 bytes naturally.
        Type::F16 => VaArgLowering {
            access: VaArgAccess::Direct,
            load_size: 8,
            slot_align: 8,
            advance_bytes: 8,
        ...
        // 64-bit NEON (D-register) vector: 8-byte aligned, 8-byte slot.
        Type::V64 => VaArgLowering {
            access: VaArgAccess::Direct,
            load_size: 8,
            slot_align: 8,
            advance_bytes: 8,
...
mod tests {
    ...
    fn va_start_intrinsic_construction() {
        let intr = VaListIntrinsic::VaStart {
            stack_vararg_offset: 32,
        };
        assert_eq!(
            intr,
            VaListIntrinsic::VaStart {
                stack_vararg_offset: 32
            }
        );
    }
    ...
    fn va_arg_intrinsic_construction() {
        let intr = VaListIntrinsic::VaArg {
            arg_type: Type::I32,
        };
        assert_eq!(
            intr,
            VaListIntrinsic::VaArg {
                arg_type: Type::I32
            }
        );
    }
