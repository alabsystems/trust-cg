// Shared JSON result schema for `trust-cg-test`.
//
// Author: Andrew Yates <andrewyates.name@gmail.com>
// Copyright 2026 Andrew Yates | License: Apache-2.0
//
// `RunSummary<T>` is a generic building block for result-emitting commands.
// Command-specific output shapes remain unstable in v0.1.0. Generic JSON
// schemas live under `evals/schema/`; `trust-cg-test ratchet schema` verifies
// that the committed files match what `schemars` emits today.

//! Result types for every `trust-cg-test` subcommand.
