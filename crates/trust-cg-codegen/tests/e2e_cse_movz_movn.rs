// trust-cg-codegen/tests/e2e_cse_movz_movn.rs — regression test for #432
//
...
use trust_cg_ir::regs::{X0, X9, X10};
use trust_cg_opt::cse::CommonSubexprElim;
...
fn make_test_dir(name: &str) -> PathBuf {
    let dir = std::env::temp_dir().join(format!("trust_cg_e2e_432_{}", name));
