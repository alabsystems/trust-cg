// trust-cg-codegen/tests/jit_tls.rs - TLS-via-pointer JIT convention test
//
// Author: Andrew Yates <andrewyates.name@gmail.com>
// Copyright 2026 Andrew Yates | License: Apache-2.0
//
// Part of #361 — JIT needs thread-local storage (TLS) access for ty model checker
//
...
thread_local! {
    static SCRATCH: UnsafeCell<u64> = const { UnsafeCell::new(0) };
}
