// trust-cg-codegen/tests/jit_block_counter_lifetime.rs
...
fn build_diamond() -> MachFunction {
    ...
    // Exact semantic CFG, including encoded branches and layout fallthroughs.
    // `add_edge` updates successor and predecessor metadata together.
