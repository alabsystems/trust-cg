// trust-cg-codegen/aarch64/encoding.rs - AArch64 instruction encoding
//
...
/// ```
///
/// `ROR Rd, Rn, #shift` is encoded as `EXTR Rd, Rn, Rn, #shift`.
///
/// Source: `BaseExtract` in `AArch64InstrFormats.td`
pub fn encode_extract(sf: u32, n: u32, rm: u32, imms: u32, rn: u32, rd: u32) -> u32 {
    debug_assert!(sf <= 1);
    debug_assert!(n <= 1);
    debug_assert!(rm <= 31);
...
/// Encode **Bit Reverse** — RBIT.
///
/// ```text
/// 31  30:21       20:16  15:10   9:5  4:0
/// sf  1011010110  00000  000000  Rn   Rd
/// ```
///
/// Source: `BaseDataProcessing1Source` in `AArch64InstrFormats.td`.
pub fn encode_bit_reverse(sf: u32, rn: u32, rd: u32) -> u32 {
    debug_assert!(sf <= 1);
    debug_assert!(rn <= 31);
    debug_assert!(rd <= 31);
...
pub fn encode_add_sub_imm(sf: u32, op: u32, s: u32, sh: u32, imm12: u32, rn: u32, rd: u32) -> u32 {
    debug_assert!(sf <= 1);
    debug_assert!(op <= 1);
    debug_assert!(s <= 1);
    debug_assert!(sh <= 1);
...
pub fn encode_load_store_ui(size: u32, v: u32, opc: u32, imm12: u32, rn: u32, rt: u32) -> u32 {
...
pub fn encode_load_store_unscaled(size: u32, v: u32, opc: u32, imm9: i32, rn: u32, rt: u32) -> u32 {
    debug_assert!(size <= 0b11);
    debug_assert!(v <= 1);
    debug_assert!(opc <= 0b11);
...
mod tests {
    ...
    fn test_add_shifted_reg_with_shift() {
        ...
        let expected = (1u32 << 31) | (0b01011 << 24) | (2 << 16) | (3 << 10) | (1 << 5);
    ...
    fn test_sub_shifted_reg_xzr() {
        ...
        let expected = ((1u32 << 31) | (1 << 30) | (0b01011 << 24) | (1 << 16)) | 31;
    ...
    fn test_add_shifted_reg_asr() {
        ...
        let expected =
            (1u32 << 31) | (0b01011 << 24) | (0b10 << 22) | (7 << 16) | (4 << 10) | (6 << 5) | 5;
    ...
    fn test_add_x0_x1_imm42() {
        ...
        let expected = (1u32 << 31) | (0b100010 << 23) | (42 << 10) | (1 << 5);
    ...
    fn test_subs_imm_max() {
        ...
        let expected =
            (1u32 << 31) | (1 << 30) | (1 << 29) | (0b100010 << 23) | (0xFFF << 10) | (1 << 5);
    ...
    fn test_add_imm_sp() {
        ...
        let expected = (1u32 << 31) | (0b100010 << 23) | (16 << 10) | (31 << 5) | 31;
    ...
    fn test_movz_x0_0x1234() {
        ...
        let expected = (1u32 << 31) | (0b10 << 29) | (0b100101 << 23) | (0x1234u32 << 5);
    ...
    fn test_movz_w0_0xffff() {
        ...
        let expected = (0b10u32 << 29) | (0b100101 << 23) | (0xFFFF << 5);
    ...
    fn test_ret_x30() {
        ...
        let expected = (0b1101011u32 << 25) | (0b0010 << 21) | (0b11111 << 16) | (30 << 5);
    ...
    fn test_blr_x15() {
        // BLR X15
        // opc=0001, Rn=15
        let expected = (0b1101011u32 << 25) | (0b0001 << 21) | (0b11111 << 16) | (15 << 5);
    ...
    fn test_ldr_w0_x1() {
        ...
        let expected = (0b10u32 << 30) | (0b111 << 27) | (0b01 << 24) | (0b01 << 22) | (1 << 5);
    ...
    fn test_str_x_sp_base() {
        ...
        let expected = (0b11u32 << 30) | (0b111 << 27) | (0b01 << 24) | (31 << 5);
    ...
    fn test_stp_w_pair() {
        ...
        let expected = (0b101u32 << 27) | (0b010 << 23) | (2 << 15) | (3 << 10) | (4 << 5) | 2;
