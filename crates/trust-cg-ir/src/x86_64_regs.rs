// trust-cg-ir - x86-64 register model
//
...
impl X86PReg {
    ...
    pub fn is_allocatable(self) -> bool {
        ...
        self.is_gpr() && hw != 4 && hw != 5 || self.is_xmm()
    }
...
pub const X86_CALLEE_SAVED_GPRS: [X86PReg; 6] = [RBX, RBP, R12, R13, R14, R15];
...
pub const X86_CALLER_SAVED_GPRS: [X86PReg; 9] = [RAX, RCX, RDX, RSI, RDI, R8, R9, R10, R11];
...
pub const X86_ARG_XMMS: [X86PReg; 8] = [XMM0, XMM1, XMM2, XMM3, XMM4, XMM5, XMM6, XMM7];
...
pub const X86_CALLEE_SAVED_GPR32S: [X86PReg; 6] = [EBX, EBP, R12D, R13D, R14D, R15D];
...
mod tests {
    ...
    fn test_reg_class_method_matches_function() {
        ...
        let test_regs = [
            RAX, EAX, AX, AL, XMM0, RFLAGS, RIP, R15, R15D, R15W, R15B, XMM15,
        ];
