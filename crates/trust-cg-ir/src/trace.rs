...
//! enabling full instruction-level provenance from trust_ir input to binary output.
//!
//! # Opt-in levels
//!
...
use crate::provenance::{PassId, TrustIrInstId};
...
// PassId and TrustIrInstId are imported from crate::provenance (canonical definitions).
...
pub enum EventKind {
    ...
    /// A trust_ir instruction was lowered to one or more machine instructions.
    Lowered {
        trust_ir_inst: TrustIrInstId,
...
pub enum Justification {
    ...
    /// An SMT solver (ay) proved semantic equivalence.
    SolverProved {
...
mod tests {
    ...
    fn json_serialization() {
        ...
        trace.emit(
            PassId::new("1"),
            EventKind::Lowered {
                trust_ir_inst: TrustIrInstId(42),
    ...
    fn all_event_kinds() {
        ...
        let kinds = vec![
            ...
            EventKind::Lowered {
                trust_ir_inst: TrustIrInstId(10),
