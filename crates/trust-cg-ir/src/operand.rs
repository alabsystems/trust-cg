...
mod tests {
    ...
    fn as_preg_none() {
        ...
        assert_eq!(
            MachOperand::VReg(VReg::new(0, RegClass::Gpr64)).as_preg(),
            None
        );
    }
    ...
    fn operand_equality_memop() {
        let a = MachOperand::MemOp {
            base: X0,
            offset: 8,
        };
        let b = MachOperand::MemOp {
            base: X0,
            offset: 8,
        };
        let c = MachOperand::MemOp {
            base: X0,
            offset: 16,
        };
        let d = MachOperand::MemOp {
            base: X1,
            offset: 8,
        };
        assert_eq!(a, b);
    ...
    fn operand_equality_symbol() {
        ...
        assert_ne!(MachOperand::Symbol("foo".to_string()), MachOperand::Imm(0));
    }
}
